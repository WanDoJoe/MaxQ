 ...
 * 模仿淘宝购物车界面
 */
public class ShopcartActivity extends BaseActivity implements ShopcartAdapter.CheckInterface,
...
//		R.id.all_chekbox, R.id.tv_delete, R.id.tv_go_to_pay, R.id.subtitle, R.id.tv_save, R.id.tv_share
		statusBar(findViewById(R.id.shopcar_layout),R.color.white);
